...
const TreatmentCoursesMenu: React.FC<TreatmentCoursesPopupProps> = (props: TreatmentCoursesPopupProps) => {
    ...
    const handleAddCourse = () => {
        const newTcs = [...treatmentCourses, {drug: selectedDrug, atTime: selectedTime}]
    ...
    return (
        <>
            ...
            <select name="drug" id="drugSelect" value={selectedDrug} onChange={handleDrugChange}>
                ...
                {treatmentCourses.map((tc, index) => {
                    return (
                        <p style={{textAlign: "right"}} key={index}>
                            ...
                            <button style={{marginLeft: "20px"}} onClick={() => handleRemove(index)}>remove</button>
                        </p>
                    )
                })}
            </div>
