...
const Parameters: React.FC<ParametersProps> = (props: ParametersProps) => {
    ...
    const setToInitialParams = () => {
        setLeukemicAggressiveGrowth(props.initParams.growthFactors.leukemicAggressive);
        setLeukemicNonAggressiveGrowth(props.initParams.growthFactors.leukemicNonAggressive);
                ...
                return (
                    <div key={drugName}>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                      setDrugActions(ds => ds.map(d =>
                                          d.name === drugName ?{...d, wareOffTime: +e.target.value} : d))} />
                        <br />
                        ...
                        <input
                            type="number"
                            min="0"
                            value={drugActions.find(i => i.name === drugName)?.killFactor.redbloodcells}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                      setDrugActions(ds => ds.map(d =>
                                          d.name === drugName ? {
                                              ...d,
                                              killFactor: {...d.killFactor, redbloodcells: +e.target.value}
                                          } : d))} />
                        <br />
                        ...
                        <input
                            type="number"
                            min="0"
                            value={drugActions.find(i => i.name === drugName)?.killFactor.whitebloodcells}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                      setDrugActions(ds => ds.map(d =>
                                          d.name === drugName ? {
                                              ...d,
                                              killFactor: {...d.killFactor, whitebloodcells: +e.target.value}
                                          } : d))} />
                        <br />
                        ...
                        <input
                            type="number"
                            min="0"
                            value={drugActions.find(i => i.name === drugName)?.killFactor.thrombocytes}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                                      setDrugActions(ds => ds.map(d =>
                                          d.name === drugName ? {
                                              ...d,
